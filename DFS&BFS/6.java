...
public class Main6 {
    ...
    public static ArrayList<Position> teachers = new ArrayList<Position>(); // 모든 선생님 위치 정보
    public static ArrayList<Position> spaces = new ArrayList<Position>();   // 모든 빈 공간 위치 정보
